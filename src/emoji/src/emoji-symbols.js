...
export default class EmojiSymbols extends Plugin {
    ...
    init() {
        ...
        editor.plugins.get( 'Emoji' ).addItems( '❤️',
            [
                ...
                { title: 'Eye in Speech Bubble', character: '👁️' }, 
                ...
                { title: 'Twelve-Thirty', character: '🕧' },
                 ...
                 { title: 'SOS Button', character: '🆘' }, { title: 'Up! Button', character: '🆙' }, { title: 'Vs Button', character: '🆚' }, { title: 'Japanese “Here” Button', character: '🈁' }, { title: 'Japanese “Service Charge” Button', character: '🈂️' }, { title: 'Japanese “Monthly Amount” Button', character: '🈷️' }, { title: 'Japanese “Not Free of Charge” Button', character: '🈶' }, { title: 'Japanese “Reserved” Button', character: '🈯' }, { title: 'Japanese “Bargain” Button', character: '🉐' }, { title: 'Japanese “Discount” Button', character: '🈹' }, { title: 'Japanese “Free of Charge” Button', character: '🈚' }, { title: 'Japanese “Prohibited” Button', character: '🈲' }, { title: 'Japanese “Acceptable” Button', character: '🉑' }, { title: 'Japanese “Application” Button', character: '🈸' }, { title: 'Japanese “Passing Grade” Button', character: '🈴' }, { title: 'Japanese “Vacancy” Button', character: '🈳' }, { title: 'Japanese “Congratulations” Button', character: '㊗️' }, { title: 'Japanese “Secret” Button', character: '㊙️' }, { title: 'Japanese “Open for Business” Button', character: '🈺' }, { title: 'Japanese “No Vacancy” Button', character: '🈵' }, { title: 'Red Circle', character: '🔴' }, { title: 'Orange Circle', character: '🟠' }, { title: 'Yellow Circle', character: '🟡' }, { title: 'Green Circle', character: '🟢' }, { title: 'Blue Circle', character: '🔵' }, { title: 'Purple Circle', character: '🟣' }, { title: 'Brown Circle', character: '🟤' }, { title: 'Black Circle', character: '⚫' }, { title: 'White Circle', character: '⚪' }, { title: 'Red Square', character: '🟥' }, { title: 'Orange Square', character: '🟧' }, { title: 'Yellow Square', character: '🟨' }, { title: 'Green Square', character: '🟩' }, { title: 'Blue Square', character: '🟦' }, { title: 'Purple Square', character: '🟪' }, { title: 'Brown Square', character: '🟫' }, { title: 'Black Large Square', character: '⬛' }, { title: 'White Large Square', character: '⬜' }, 
                 { title: 'Large Orange Diamond', character: '🔶' }, { title: 'Large Blue Diamond', character: '🔷' }, { title: 'Small Orange Diamond', character: '🔸' }, { title: 'Small Blue Diamond', character: '🔹' }, { title: 'Red Triangle Pointed Up', character: '🔺' }, { title: 'Red Triangle Pointed Down', character: '🔻' }, { title: 'Diamond with a Dot', character: '💠' }, { title: 'Radio Button', character: '🔘' }, { title: 'White Square Button', character: '🔳' }, { title: 'Black Square Button', character: '🔲' },
            ]
        );
    }
}
